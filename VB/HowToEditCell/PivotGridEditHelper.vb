...
Namespace HowToEditCell
	...
	Friend Class PivotGridEditHelper
		...
		Public Shared ReadOnly Property Enter() As ICommand
			Get
                Return New DelegateCommand(Of Object)(AddressOf OnEditValue, Nothing, False)
            End Get
		End Property
		Public Shared ReadOnly Property StartEdit() As ICommand
			Get
...
'INSTANT VB NOTE: The variable newValue was renamed since Visual Basic does not allow variables and other class members to have the same name:
'INSTANT VB NOTE: The variable oldValue was renamed since Visual Basic does not allow variables and other class members to have the same name:
